...
```{r, pca-and-screeplot}
# perform pca
pr_comp = prcomp(all %>% ungroup() %>% select(height, humidity, humid_temp, incident_par, reflected_par), center = TRUE, scale. = TRUE)
summary(pr_comp)
pr_comp
