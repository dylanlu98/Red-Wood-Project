...
plot1 = ggcorr(sunrise[c("humidity","humid_temp","incident_par", "reflected_par")], method = c("everything", "pearson")) +
  labs(title = "Correlation Map - Sunrise") + theme(legend.position = "none") 
plot2 = ggcorr(sunset[c("humidity","humid_temp","incident_par", "reflected_par")], method = c("everything", "pearson")) +
  labs(title = "Correlation Map - Sunset") + theme(legend.position = "none") 
...
plot1 = ggplot(sunrise, aes(x=incident_par, y=humid_temp) ) +
  ...
  ggtitle("Sunrise") + labs(x= "Incident PAR", y = "Temperature")

plot2 = ggplot(sunset, aes(x=incident_par, y=humid_temp) ) +
  geom_point() + theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle("Sunset") + labs(x= "Incident PAR", y = "Temperature")
grid.arrange(plot1, plot2, ncol=2)
########### 
...
plot1 = ggplot(sunrise, aes(x=incident_par, y=humidity) ) +
  geom_point() + theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle("Sunrise") + labs(x= "Incident PAR", y = "Humidity")

plot2 = ggplot(sunset, aes(x=incident_par, y=humidity) ) +
  geom_point() + theme(plot.title = element_text(hjust = 0.5)) +
  ggtitle("Sunset") + labs(x= "Incident PAR", y = "Humidity")
grid.arrange(plot1, plot2, ncol=2)
########### 
...
Many interesting pairwise scatter plots were analyzed for trends. We highlight some of our more interesting findings below.
