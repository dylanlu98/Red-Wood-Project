...
```{r, remove-na-values}
test = all %>% filter(is.na(humid_temp) & is.na(humidity) & is.na(humid_temp) & is.na(hamatop) & is.na(hamabot))
...
#quantile(all$humidity, prob = c(.01,.95))

quantile(all$humid_temp, prob= c(0.25, 0.95))
