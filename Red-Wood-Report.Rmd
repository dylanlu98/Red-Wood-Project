...
### Finding 3
Our question is does the height determine the humidity and temperature during day time?
...
jpeg("q4-interesting finding 3-height-value-box-plots.jpeg", width = 20, height = 12, units = 'in', res = 300)
ggarrange(temp, humid,
                    labels = c("Temperature", "Humidity", "Incident PAR", "Reflected PAR"),
                    ncol = 1, nrow = 2)
dev.off
```
![Box plot of humidity and temperature along heights](./images/q4-interesting finding 3-height-value-box-plots.jpeg)
