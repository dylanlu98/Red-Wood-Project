...
```{r, interesting-finding-2_DL}
#Can we cluster measurements by day?
#Spread data our such that we have data from every day, and then do a clustering to see if can identify what range of date the cluster is from. 
```
***
