...
General Notes/To do:
- PAR measurements are off, the units are flux. I'm not sure if we need to just scale the given values or do any manipulation. I think we should have our min/max match the table in the paper
- Need to derive reflected PAR from direct PAR (just a ratio)
- 
...
Large amount of outliers for Hamatop
